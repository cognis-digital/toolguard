#!/usr/bin/env sh
# Universal installer for toolguard. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/toolguard.git"
echo "Installing toolguard ..."
