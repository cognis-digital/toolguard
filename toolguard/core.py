"""TOOLGUARD core — Runtime allowlist and policy for agent tool-calls."""
...
RULES = [
    ("TOO-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("TOO-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("TOO-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
