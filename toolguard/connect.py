"""Native cognis-connect emit for toolguard — forward findings to any platform.

Maps toolguard's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    toolguard ... --format json | toolguard-emit --to stix
    toolguard-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
